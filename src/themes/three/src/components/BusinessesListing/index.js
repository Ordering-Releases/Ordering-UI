        ...
        <BusinessListContainer>
          <WrapBusinessSort>
            <BusinessSortContainer>
              ...
              >
                {businessSortTypes.map(type => (
                  <BusinessSortItem
                    key={type.value}
                    onClick={() => handleChangeOrderBy(type.value)}
                  >
                    {orderByValue === type.value ? <IosRadioButtonOn /> : <IosRadioButtonOff />}
                    {type.content}
                  </BusinessSortItem>
                ))}
              </BusinessSortContent>
