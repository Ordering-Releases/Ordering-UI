  ...
  return (
    <>
      ...
      <SignUpContainer isPopup={isPopup}>
        <FormSide isPopup={isPopup} isSignupEmail={isSignupEmail}>
          <Title>{t('FRONT_CREATE_AN_ACCOUNT', 'Create an account')}</Title>
          {!isSignupEmail ? (
            <>
              <Description>
                ...
                <>
                  {Object.keys(configs).length > 0 ? (
                    <SocialButtons isPopup={isPopup}>
                      ...
                      >
                        {t('SIGN_UP_WITH_EMAIL', 'Sign up with Email')}
                      </Button>
                    </SocialButtons>
                  ) : (
                    <SkeletonSocialWrapper>
                ...
                >
                  {
                    formState.loading
                      ...
                      : !isSignupBusiness
                        ...
                        : t('FRONT_CREATE_AN_ACCOUNT', 'Create an account')
                  }
                </Button>
              )}
