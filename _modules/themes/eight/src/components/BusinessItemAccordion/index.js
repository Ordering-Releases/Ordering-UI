...
var BusinessItemAccordion = function BusinessItemAccordion(props) {
  var _Object$values$find$b, _Object$values$find, _props$beforeElements, _props$beforeComponen, _theme$images, _theme$images2, _orderState$options, _props$afterComponent, _props$afterElements;
  ...
  }, !isCustomMode && /*#__PURE__*/_react.default.createElement(_styles.Accordion, {
    isClosed: isClosed,
    className: "accordion ".concat(setActive, " business-item"),
