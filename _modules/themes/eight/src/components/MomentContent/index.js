...
var MomentContent = function MomentContent(props) {
  var _configs$max_days_pre, _props$beforeElements, _props$beforeComponen, _orderState$options, _orderState$options$a, _props$afterComponent, _props$afterElements;
