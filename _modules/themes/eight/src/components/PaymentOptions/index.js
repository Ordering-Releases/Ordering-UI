...
var PaymentOptionsUI = function PaymentOptionsUI(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    var _paymethodsOptions = _filteredPaymethods.map(function (paymethod) {
      return {
        value: paymethod.id,
        content: /*#__PURE__*/_react.default.createElement(_styles2.PayCardOption, null, t(paymethod.gateway.toUpperCase(), paymethod.name))
      };
    });
  ...
  }), /*#__PURE__*/_react.default.createElement(_styles2.PaymentMethodsContainer, null, /*#__PURE__*/_react.default.createElement(_styles2.PaymentMethodsList, {
    className: "payments-list"
  }, paymethodsOptions.length > 0 && /*#__PURE__*/_react.default.createElement(_styles2.WrapPaymethodSelect, null, /*#__PURE__*/_react.default.createElement(_styles.Select, {
    options: paymethodsOptions,
    defaultValue: paymethodSelected === null || paymethodSelected === void 0 ? void 0 : paymethodSelected.id,
    placeholder: /*#__PURE__*/_react.default.createElement(_styles2.PayCardOption, null, t('SELECT_PAYMETHOD', 'Select paymethod')),
    onChange: function onChange(paymethodId) {
      return handleChangePaymethod(paymethodId);
    }
  })), (paymethodsList.loading || isLoading) && /*#__PURE__*/_react.default.createElement(_styles2.PayCardOption, {
    isSkeleton: true
