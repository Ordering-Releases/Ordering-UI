...
var PaymentOptionsUI = function PaymentOptionsUI(props) {
  ...
  var _useState = (0, _react.useState)([]),
    ...
    paymethodsOptions = _useState2[0],
    setPaymethodsOptions = _useState2[1];
  ...
  var handleChangePaymethod = function handleChangePaymethod(paymethodId) {
  ...
  (0, _react.useEffect)(function () {
    ...
    var _filteredPaymethods = paymethodsList.paymethods.sort(function (a, b) {
      return a.id - b.id;
    }).filter(function (paymethod) {
      return !isCustomerMode || isCustomerMode && (paymethod.gateway === 'card_delivery' || paymethod.gateway === 'cash');
    });
    var _paymethodsOptions = _filteredPaymethods.map(function (paymethod) {
      return {
        value: paymethod.id,
        content: /*#__PURE__*/_react.default.createElement(_styles.PayCardOption, null, t(paymethod.gateway.toUpperCase(), paymethod.name))
      };
    });
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, (_props$beforeElements = props.beforeElements) === null || _props$beforeElements === void 0 ? void 0 : _props$beforeElements.map(function (BeforeElement, i) {
  ...
  }, paymethodsOptions.length > 0 && /*#__PURE__*/_react.default.createElement(_styles.WrapPaymethodSelect, null, /*#__PURE__*/_react.default.createElement(_Select.Select, {
    options: paymethodsOptions,
    defaultValue: paymethodSelected === null || paymethodSelected === void 0 ? void 0 : paymethodSelected.id,
    placeholder: /*#__PURE__*/_react.default.createElement(_styles.PayCardOption, null, t('SELECT_PAYMETHOD', 'Select paymethod')),
    onChange: function onChange(paymethodId) {
      return handleChangePaymethod(paymethodId);
    }
  })), (paymethodsList.loading || isLoading) && /*#__PURE__*/_react.default.createElement(_styles.PayCardOption, {
    isSkeleton: true
  ...
  }), (isOpenMethod === null || isOpenMethod === void 0 || (_isOpenMethod$paymeth = isOpenMethod.paymethod) === null || _isOpenMethod$paymeth === void 0 ? void 0 : _isOpenMethod$paymeth.gateway) === 'stripe' && ((_isOpenMethod$paymeth2 = isOpenMethod.paymethod) === null || _isOpenMethod$paymeth2 === void 0 ? void 0 : _isOpenMethod$paymeth2.gateway) === 'stripe' && /*#__PURE__*/_react.default.createElement(_PaymentOptionStripe.PaymentOptionStripe, {
    ...
    open: (isOpenMethod === null || isOpenMethod === void 0 || (_isOpenMethod$paymeth5 = isOpenMethod.paymethod) === null || _isOpenMethod$paymeth5 === void 0 ? void 0 : _isOpenMethod$paymeth5.gateway) === 'paypal' && !paymethodData.id,
    onClose: function onClose() {
      return handlePaymethodClick(null);
    },
    title: t('PAY_WITH_PAYPAL', 'Pay with PayPal')
  }, (isOpenMethod === null || isOpenMethod === void 0 || (_isOpenMethod$paymeth6 = isOpenMethod.paymethod) === null || _isOpenMethod$paymeth6 === void 0 ? void 0 : _isOpenMethod$paymeth6.gateway) === 'paypal' && /*#__PURE__*/_react.default.createElement(_PaymentOptionPaypal.PaymentOptionPaypal, {
    clientId: isOpenMethod === null || isOpenMethod === void 0 || (_isOpenMethod$paymeth7 = isOpenMethod.paymethod) === null || _isOpenMethod$paymeth7 === void 0 || (_isOpenMethod$paymeth7 = _isOpenMethod$paymeth7.credentials) === null || _isOpenMethod$paymeth7 === void 0 ? void 0 : _isOpenMethod$paymeth7.client_id,
    body: {
      paymethod_id: isOpenMethod === null || isOpenMethod === void 0 || (_isOpenMethod$paymeth8 = isOpenMethod.paymethod) === null || _isOpenMethod$paymeth8 === void 0 ? void 0 : _isOpenMethod$paymeth8.id,
      amount: cart.total,
