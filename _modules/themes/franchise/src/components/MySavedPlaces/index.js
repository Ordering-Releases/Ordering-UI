...
var MySavedPlacesUI = function MySavedPlacesUI(props) {
  var _theme$images;
  ...
  return /*#__PURE__*/_react.default.createElement(_styles.MySavedPlacesContainer, null, /*#__PURE__*/_react.default.createElement("h1", null, t('MY_ADDRESSES', 'My Saved places')), user !== null && user !== void 0 && user.addresses ? /*#__PURE__*/_react.default.createElement(_AddressList.AddressList, {
    isModal: true,
...
var MySavedPlaces = exports.MySavedPlaces = function MySavedPlaces(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_orderingComponentsExternal.UserFormDetails, mySavedPlacesProps);
};