...
var SkeletonsContainer = _styledComponents.default.div(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n  margin-top: 25px;\n"])));
exports.SkeletonsContainer = SkeletonsContainer;
var ChangeCustomerText = _styledComponents.default.div(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n\n  span {\n    font-size: 13px;\n    color: ", ";\n    cursor: pointer;\n    user-select: none;\n    &:hover {\n        text-decoration: underline;\n      }\n  }\n"])), function (props) {
  return props.theme.colors.primary;
});
exports.ChangeCustomerText = ChangeCustomerText;