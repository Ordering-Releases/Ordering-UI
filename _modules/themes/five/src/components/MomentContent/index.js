...
var MomentContent = exports.MomentContent = function MomentContent(props) {
  var _props$preorderMaximu, _configs$max_days_pre, _document, _props$beforeElements, _props$beforeComponen, _orderState$options, _props$afterComponent, _props$afterElements;
  var _useConfig = (0, _orderingComponentsExternal.useConfig)(),
    _useConfig2 = _slicedToArray(_useConfig, 1),
    _useConfig2$ = _useConfig2[0],
    configs = _useConfig2$.configs,
    loading = _useConfig2$.loading;
  var limitDays = parseInt((_props$preorderMaximu = props.preorderMaximumDays) !== null && _props$preorderMaximu !== void 0 ? _props$preorderMaximu : configs === null || configs === void 0 || (_configs$max_days_pre = configs.max_days_preorder) === null || _configs$max_days_pre === void 0 ? void 0 : _configs$max_days_pre.value, 10);
