...
var PaymentOptionsUI = function PaymentOptionsUI(props) {
  ...
  }, !(paymethodsList.loading || isLoading || loadingOptions) && supportedMethods.length > 0 && supportedMethods.sort(function (a, b) {
    return a.id - b.id;
