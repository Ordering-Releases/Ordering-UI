...
var CheckoutUI = function CheckoutUI(props) {
  ...
  validateCommentsCartField || validateDriverTipField || validateCouponField || validateZipcodeCard || !!alseaCheckPriceError;
