...
var SignUpBusinessUI = function SignUpBusinessUI(props) {
  var _validationFields$fie, _validationFields$fie2, _configs$verification, _theme$images, _props$beforeMidEleme, _props$beforeMidCompo, _validationFields$fie6, _validationFields$fie7, _props$afterMidElemen, _props$afterMidCompon, _configs$terms_and_co, _configs$terms_and_co2;
  ...
  return /*#__PURE__*/_react.default.createElement(_styles.SignupBusinessContainer, {
    bgImage: (_theme$images = theme.images) === null || _theme$images === void 0 || (_theme$images = _theme$images.general) === null || _theme$images === void 0 ? void 0 : _theme$images.businessSignUpBG
  }, /*#__PURE__*/_react.default.createElement(_styles.SignupDescriptionContainer, null, /*#__PURE__*/_react.default.createElement(_styles.SignupDescriptionTitle, null, t('START_SELLING_WITH_US', 'Start Selling with us.')), /*#__PURE__*/_react.default.createElement(_styles.SignupDescriptionContent, null, t('REGISTER_AS_NEW_BUSINESS_TERMS', 'Register as a new business owner and create your store to sell your products or services in _Domain_or_brand_ Website and Native Apps for iOS & Android.').replace('_Domain_or_brand_', 'test'))), /*#__PURE__*/_react.default.createElement(_styles.FormSide, null, /*#__PURE__*/_react.default.createElement(_styles.SignUpTitle, null, t('SIGN_UP_NOW', 'Sign up now')), /*#__PURE__*/_react.default.createElement(_styles.FormInput, {
    noValidate: true,
    isPopup: isPopup,
