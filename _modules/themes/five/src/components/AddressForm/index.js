...
var AddressFormUI = function AddressFormUI(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (isEditing) {
      ...
      if (formState !== null && formState !== void 0 && (_formState$changes20 = formState.changes) !== null && _formState$changes20 !== void 0 && _formState$changes20.location) {
        var _locationChange$lat, _locationChange$lng, _formState$changes21, _formState$changes22;
        var prevLocation = {
          lat: locationChange === null || locationChange === void 0 || (_locationChange$lat = locationChange.lat) === null || _locationChange$lat === void 0 ? void 0 : _locationChange$lat.toFixed(5),
          lng: locationChange === null || locationChange === void 0 || (_locationChange$lng = locationChange.lng) === null || _locationChange$lng === void 0 ? void 0 : _locationChange$lng.toFixed(5)
        };
        var newLocation = {
          lat: formState === null || formState === void 0 || (_formState$changes21 = formState.changes) === null || _formState$changes21 === void 0 || (_formState$changes21 = _formState$changes21.location) === null || _formState$changes21 === void 0 || (_formState$changes21 = _formState$changes21.lat) === null || _formState$changes21 === void 0 ? void 0 : _formState$changes21.toFixed(5),
          lng: formState === null || formState === void 0 || (_formState$changes22 = formState.changes) === null || _formState$changes22 === void 0 || (_formState$changes22 = _formState$changes22.location) === null || _formState$changes22 === void 0 || (_formState$changes22 = _formState$changes22.lng) === null || _formState$changes22 === void 0 ? void 0 : _formState$changes22.toFixed(5)
        };
  ...
  (0, _react.useEffect)(function () {
    inputNames.forEach(function (field) {
      ...
      formMethods.register(field.name, {
        required: isRequiredField(field.name) && showField(field.name) ? t("VALIDATION_ERROR_".concat(field.name, "_REQUIRED"), "The field ".concat(field.code, " is required")) : null
      });
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    }, /*#__PURE__*/_react.default.createElement(_styles.WrapAddressInput, null, /*#__PURE__*/_react.default.createElement(_orderingComponentsExternal.GoogleAutocompleteInput, {
