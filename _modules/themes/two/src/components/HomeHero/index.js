...
var HomeHero = function HomeHero(props) {
  var _props$beforeElements, _props$beforeComponen, _theme$images, _theme$images2, _orderState$options2, _orderState$options3, _props$afterComponent, _props$afterElements;
