...
var _TiArrowSortedDown = _interopRequireDefault(require("@meronex/icons/ti/TiArrowSortedDown"));
var _orderingComponentsExternal = require("ordering-components-external");
var _useWindowSize = require("../../../../../hooks/useWindowSize");
var _BiStoreAlt = _interopRequireDefault(require("@meronex/icons/bi/BiStoreAlt"));
var _AiOutlineDelete = _interopRequireDefault(require("@meronex/icons/ai/AiOutlineDelete"));
...
var BusinessItemAccordion = exports.BusinessItemAccordion = function BusinessItemAccordion(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, (_props$beforeElements = props.beforeElements) === null || _props$beforeElements === void 0 ? void 0 : _props$beforeElements.map(function (BeforeElement, i) {
  ...
  }, !isCheckout && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, !(windowSize.width < 576 && isStore) && /*#__PURE__*/_react.default.createElement(_styles.Accordion, {
    isClosed: isClosed,
    ...
    className: "go-store"
  }, windowSize.width < 576 ? /*#__PURE__*/_react.default.createElement(_BiStoreAlt.default, null) : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, t('GO_TO_STORE', 'Go to store'))), !isClosed && !!isProducts && !isCartPending && !isStore && /*#__PURE__*/_react.default.createElement("span", {
    ref: businessDelete,
    onClick: function onClick() {
      return handleClearProducts();
    },
    className: "clear-cart"
  }, windowSize.width < 576 ? /*#__PURE__*/_react.default.createElement(_AiOutlineDelete.default, null) : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, t('CLEAR_CART', 'Clear cart'))), isStore && /*#__PURE__*/_react.default.createElement("span", {
    onClick: handleChangeStore,
    className: "change-store"
  }, t('CHANGE_STORE', 'Change store'))))), !isClosed && !!isProducts && /*#__PURE__*/_react.default.createElement(_styles.BusinessTotal, {
    className: "total",
    isCartOnProductsList: isCartOnProductsList
    ...
    className: "closed"
  }, /*#__PURE__*/_react.default.createElement("p", null, t('CLOSED', 'Closed'), " ", moment)), !isClosed && !isProducts && /*#__PURE__*/_react.default.createElement(_styles.BusinessTotal, null, /*#__PURE__*/_react.default.createElement("p", null, t('NO_PRODUCTS', 'No products'))), /*#__PURE__*/_react.default.createElement(_styles.BusinessActions, null, !isClosed && !!isProducts && /*#__PURE__*/_react.default.createElement("span", null, /*#__PURE__*/_react.default.createElement(_TiArrowSortedDown.default, {
