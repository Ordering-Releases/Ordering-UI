...
var BusinessProductsCategoriesUI = function BusinessProductsCategoriesUI(props) {
  ...
  var isSkeleton = props.isSkeleton,
    ...
    onClickCategoryCustom = props.onClickCategoryCustom;
  var ProductCategories = function ProductCategories() {
    return categories && categories.length && categories.map(function (category, i, hash) {
      return /*#__PURE__*/_react.default.createElement(_Tabs.Tab, {
        ...
        onClick: function onClick() {
          return onClickCategoryCustom(category, category.id);
        },
        borderBottom: true
      }, category.name);
    });
