...
var OrdersDashboardList = function OrdersDashboardList(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, isMessagesView ? /*#__PURE__*/_react.default.createElement(_orderingComponentsExternal.DashboardOrdersList, _extends({
    isMessagesView: true
  ...
  })) : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_orderingComponentsExternal.DashboardOrdersList, _extends({
    groupStatus: "pending"
  }, OrdersCommonControlProps, {
    orderStatus: selectedSubOrderStatus === null || selectedSubOrderStatus === void 0 ? void 0 : selectedSubOrderStatus.pending
  })), /*#__PURE__*/_react.default.createElement(_orderingComponentsExternal.DashboardOrdersList, _extends({
