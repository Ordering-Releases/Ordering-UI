...
var Info = _styledComponents.default.p(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral([""])));
exports.Info = Info;
var SelectContainer = _styledComponents.default.div(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n  display: flex;\n  width: 60%;\n  position: relative;\n  align-items: center;\n  svg{\n    position: absolute;\n    top: 0;\n    left: 20px;\n    transform: translate(50%, 70%);\n    z-index: 10;\n  }\n  > div {\n    width: 100%;\n    .select__placeholder, .select__single-value, input {\n      margin-left: 40px;\n      z-index: 100;\n      bottom: -10px;\n    }\n    .select__menu {\n      position: relative;\n      padding: 20px;\n    }\n    .select__clear-indicator {\n      position: relative;\n      left: 0;\n      transform: translate(-300%, -165%);\n      svg{\n        width: 30px;\n        height: 30px;\n      }\n    }\n    .select__control {\n      height: 45px;\n      padding-left: 10px;\n      width: 110%;\n    }\n    .select__indicator {\n      bottom: 8px;\n      position: relative;\n    }\n    .select__menu{\n      top: 45px;\n    }\n    input {\n      position: relative;\n      top: -5px;\n    }\n  }\n"])));
exports.SelectContainer = SelectContainer;
var SearchContainer = _styledComponents.default.div(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 0;\n  width: 90%;\n"])));
...
var TypeButton = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  display: flex;\n  align-items: center;\n  width: 215px;\n  height: 75px;\n  border-radius: 7.6px;\n  padding: 16px;\n  box-shadow: 0px 1px 4px 0px rgba(0, 0, 0, 0.10);\n  margin-right: 32px;\n  margin-bottom: 32px;\n  cursor: pointer;\n  background: ", ";\n  p{\n    margin: 0;\n    margin-left: 33px;\n    ", "\n  }\n"])), function (_ref4) {
...
var IconTypeButton = _styledComponents.default.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 44px;\n  height: 44px;\n  background: ", ";\n  border-radius: 44px;\n"])), function (_ref6) {
  var _theme$colors4;
...
var TypesContainer = _styledComponents.default.div(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  display: flex;\n"])));
exports.TypesContainer = TypesContainer;
var AdditionalTypesContainer = _styledComponents.default.div(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["\n  width: 60%;\n  display: flex;\n  margin-bottom: 20px;\n  button {\n    padding: 4px 10px;\n    border-radius: 50px;\n    font-size: 10px;\n    line-height: 0;\n    height: 25px;\n    margin-right: 20px;\n  }\n  .activated {\n    color: ", "\n  }\n"])), function (_ref7) {
  var _theme$colors5;
...
var PhoneAutocompleteContainer = _styledComponents.default.div(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["\n  position: relative;\n  h2 {\n    font-size: 20px;\n    margin-bottom: 20px;\n  }\n"])));
exports.PhoneAutocompleteContainer = PhoneAutocompleteContainer;
var ContinueButton = _styledComponents.default.span(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["\n  position: absolute;\n  right: -20px;\n  bottom: 5px;\n  width:\n  button {\n    cursor: pointer;\n  }\n"])));
exports.ContinueButton = ContinueButton;
var NotFoundUser = _styledComponents.default.div(_templateObject33 || (_templateObject33 = _taggedTemplateLiteral(["\n  margin: 70px 0px;\n  text-align: center;\n"])));
