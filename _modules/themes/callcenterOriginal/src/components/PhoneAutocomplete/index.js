...
var PhoneAutocompleteUI = function PhoneAutocompleteUI(props) {
  var _props$beforeElements, _props$beforeComponen, _theme$images, _theme$images$general, _orderState$options2, _orderState$options2$, _orderState$options4, _orderState$options4$, _orderState$options5, _orderState$options5$, _customerState$result, _customerState$result2, _props$afterComponent, _props$afterElements;
