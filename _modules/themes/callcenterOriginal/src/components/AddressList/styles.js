...
exports.List = List;
var AddressFormContainer = _styledComponents.default.div(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["\n  z-index: 10;\n  padding-left: 10px;\n  ", "\n  ", "\n"])), function (_ref5) {
...
var TitleFormContainer = _styledComponents.default.div(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["\n  display: flex; \n  align-items: center;\n  margin-top: 7px;\n  h1 {\n    margin: auto;\n    font-size: 24px;\n  }\n"])));
exports.TitleFormContainer = TitleFormContainer;
var AddressHoverInfo = _styledComponents.default.span(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["\n  background: #FFE69C;\n  border: 1px solid #FFF3CD;\n  display: flex;\n  padding: 8px;\n  justify-content: center;\n  align-items: center;\n  border-radius: 4px;\n  position: absolute;\n  top: 0px;\n  left: 25px;\n  opacity: 0;\n  width: max-content;\n  p {\n    margin: 0;\n    color: #664D03;\n    font-size: 12px;\n  }\n\n"])));
exports.AddressHoverInfo = AddressHoverInfo;
var AddressBookMark = _styledComponents.default.div(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["\n  span {\n    opacity: 0;\n    transition: opacity 0.3s, visibility 0.3s;\n\n  }\n  &:hover + span {\n    opacity: 1;\n    transition: opacity 0.3s, visibility 0.3s;\n  }\n"])));
exports.AddressBookMark = AddressBookMark;
var AddressBookMarkContainer = _styledComponents.default.div(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["\n  position: relative;\n"])));
exports.AddressBookMarkContainer = AddressBookMarkContainer;
var AddressTitleContainer = _styledComponents.default.div(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["\n  display: flex;\n  white-space: break-spaces;\n"])));
exports.AddressTitleContainer = AddressTitleContainer;
var WithoutAddressText = _styledComponents.default.p(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["\n  text-decoration: underline;\n  color: ", ";\n  cursor: pointer;\n"])), function (_ref7) {
  var _theme$colors;
  var theme = _ref7.theme;
  return theme === null || theme === void 0 || (_theme$colors = theme.colors) === null || _theme$colors === void 0 ? void 0 : _theme$colors.primary;
});
exports.WithoutAddressText = WithoutAddressText;