...
var _HiPencil = _interopRequireDefault(require("@meronex/icons/hi/HiPencil"));
...
var AddressListUI = function AddressListUI(props) {
    ...
    props.forEach(function (prop) {
      if (address[prop]) {
        if (prop === 'location') {
          ...
          values.push(address[prop].lat === (orderState === null || orderState === void 0 || (_orderState$options = orderState.options) === null || _orderState$options === void 0 || (_orderState$options = _orderState$options.address[prop]) === null || _orderState$options === void 0 ? void 0 : _orderState$options.lat) && address[prop].lng === (orderState === null || orderState === void 0 || (_orderState$options2 = orderState.options) === null || _orderState$options2 === void 0 || (_orderState$options2 = _orderState$options2.address[prop]) === null || _orderState$options2 === void 0 ? void 0 : _orderState$options2.lng));
        } else {
          var _orderState$options3;
          values.push(address[prop] === (orderState === null || orderState === void 0 || (_orderState$options3 = orderState.options) === null || _orderState$options3 === void 0 ? void 0 : _orderState$options3.address[prop]));
        }
      } else {
  ...
  var getAddressIcon = function getAddressIcon(tag) {
    switch (tag) {
      case 'other':
        return /*#__PURE__*/_react.default.createElement(_FaPlus.default, null);
      case 'office':
        return /*#__PURE__*/_react.default.createElement(_FaRegBuilding.default, null);
      case 'home':
        return /*#__PURE__*/_react.default.createElement(_FaHome.default, null);
      case 'favorite':
        return /*#__PURE__*/_react.default.createElement(_FaRegHeart.default, null);
      default:
        return /*#__PURE__*/_react.default.createElement(_FaPlus.default, null);
    }
  };
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, (_props$beforeElements = props.beforeElements) === null || _props$beforeElements === void 0 ? void 0 : _props$beforeElements.map(function (BeforeElement, i) {
    ...
    style: {
      display: "".concat(!addressOpen ? 'flex' : 'none')
    }
    ...
    return /*#__PURE__*/_react.default.createElement(_styles.AddressItem, {
      ...
      active: checkAddress(address)
    }, /*#__PURE__*/_react.default.createElement("div", {
      className: "wrapAddress",
      onClick: function onClick() {
        return handleSetAddress(address);
      }
    }, /*#__PURE__*/_react.default.createElement(_styles.TagWrapper, null, getAddressIcon(address === null || address === void 0 ? void 0 : address.tag)), /*#__PURE__*/_react.default.createElement("div", {
      className: "address"
      ...
      className: "form"
    }, checkAddress(address) && /*#__PURE__*/_react.default.createElement("span", null, /*#__PURE__*/_react.default.createElement(_BiCheck.default, null)), /*#__PURE__*/_react.default.createElement("a", {
      className: actionStatus.loading ? 'disabled' : 'edit',
      onClick: function onClick() {
        return openAddress(address);
      }
    }, /*#__PURE__*/_react.default.createElement(_HiPencil.default, null)), /*#__PURE__*/_react.default.createElement("a", {
      className: actionStatus.loading || address.default ? 'disabled' : 'delete',
      onClick: function onClick() {
  ...
  }, t('ACCEPT', 'Accept'))), !isPopover && windowSize.width > 992 && /*#__PURE__*/_react.default.createElement(_Modal.Modal, {
    ...
    onSaveAddress: handleSaveAddress,
    userCustomerSetup: userCustomerSetup
  }))), !isPopover && addressOpen && windowSize.width < 992 && /*#__PURE__*/_react.default.createElement(_AddressForm.AddressForm, {
    userId: userId,
    addressesList: addressList === null || addressList === void 0 ? void 0 : addressList.addresses,
    useValidationFileds: true,
    address: curAddress,
