...
var OurBusinessesUI = function OurBusinessesUI(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_styles.BusinessListContainer, null, /*#__PURE__*/_react.default.createElement(_styles.InnerContainer, null, /*#__PURE__*/_react.default.createElement(_AutoScroll.AutoScroll, {
    scrollId: "ourBusinessesScroll"
  }, (isSkeleton || businessesList.loading) && _toConsumableArray(Array(20).keys()).map(function (index) {
    return /*#__PURE__*/_react.default.createElement(_styles.WrapperBusinessLogo, {
      key: index
