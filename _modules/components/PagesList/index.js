...
var PagesList = exports.PagesList = function PagesList(_ref) {
  var routes = _ref.routes;
  var _useApi = (0, _orderingComponentsExternal.useApi)(),
    _useApi2 = _slicedToArray(_useApi, 1),
    ordering = _useApi2[0];
  var _useState = (0, _react.useState)(routes),
  ...
  var getPages = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var _yield$ordering$pages, response;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return ordering.pages().get();
          case 3:
  ...
  return /*#__PURE__*/_react.default.createElement(_styles.PagesListContainer, null, /*#__PURE__*/_react.default.createElement("h2", null, t('SITEMAP', 'Site Map')), roots.map(function (route, i) {
